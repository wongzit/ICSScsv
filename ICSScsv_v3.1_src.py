...
print("*                                I C S S c s v                                *")
print("*                                                                             *")
print("*     =================== Version 3.1 for Source Code ===================     *")
#print("*     ====================== Version 3.1 for macOS ======================     *")
#print("*     ====================== Version 3.1 for Linux ======================     *")
#print("*     ================ Version 3.1 for Microsoft Windows ================     *")
print("*                           Last update: 2021-07-14                           *")
print("*                                                                             *")
...
print("\n*******************************************************************************")
print("")
print("                    2D-ICSS results are successfully saved.")
